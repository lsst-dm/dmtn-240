...
\author{William~O'Mullane,$^1$ Frossie~Economou,$^1$ Kian-Tat~Lim,$^2$ Fritz~Mueller,$^2$ Tim~Jenness,$^1$ Gregory~P.~Dubois-Felsmann,$^3$ Leanne~P.~Guy,$^1$ Ian~S.~Sullivan,$^4$ Yusra~AlSayyad,$^5$ John~D.~Swinbank,$^4$ $^5$ and K.~Simon~Krughoff$^1$}
